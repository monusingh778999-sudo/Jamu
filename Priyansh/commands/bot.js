...
if ((event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "bot love u")) {
   ...
   if ((event.body.toLowerCase() == "jamal") || (event.body.toLowerCase() == "जमाल पठान") || (event.body.toLowerCase() == "जमाल") || (event.body.toLowerCase() == "जमाल पठान")) {
     return api.sendMessage( " जमाल घर का बर्तन झाड़ू करने मै बिजी है  मुझे बोलो बाबू मै हूँ ना किया काम है बताओ https://www.facebook.com/share/19W2oNtUuX/😘",threadID);
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
   ...
   if ((event.body.toLowerCase() == "hm") || (event.body.toLowerCase() == "hmm")) {
     return api.sendMessage("️हा हा ना करो शीधा शीधा बोलो. ई लव यू बोट जानू 🙈", threadID);
   };
